  ...
  return (
    ...
    >
      <div className="w-full space-y-4 animate-pulse select-none">
        {/* Card Progres Belajar Bab Shimmer (Sesuai card di StudentModuleLessonList) */}
        ...
        <div className="space-y-0">
          {[1, 2, 3, 4].map((i, idx) => (
            <div key={i} className="relative flex items-center gap-3 mb-3">
              ...
              <div className="flex-1 p-3.5 rounded-2xl border border-slate-200/90 bg-white shadow-2xs flex items-center justify-between gap-3">
